    ...
    <div className="bg-white shadow-sm rounded-lg p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          This visualization demonstrates how the traditional and GenAI approaches integrate into the overall
          data product strategy. Click on an approach to see the active components and data flow.
        </p>
      </div>
      ...
      <div className="flex justify-center gap-4 mb-6">
        <button
          ...
          onClick={() => toggleApproach('traditional')}
        >
      ...
      <div className="border border-gray-200 rounded-lg p-4 relative">
        <svg viewBox="0 0 900 500" className="w-full h-auto">
          ...
          <g className="data-sources">
            <rect x="50" y="50" width="800" height="80" rx="5" fill="#f8fafc" stroke="#94a3b8" strokeWidth="1" />
            <text x="450" y="35" textAnchor="middle" fill="#64748b" fontWeight="bold" fontSize="14">Data Sources</text>

            <rect x="100" y="70" width="180" height="40" rx="5" fill="#dbeafe" stroke="#3b82f6" strokeWidth="1" />
            <text x="190" y="95" textAnchor="middle" fill="#1e40af" fontSize="12">Enterprise Data Lake</text>

            <rect x="360" y="70" width="180" height="40" rx="5" fill="#dbeafe" stroke="#3b82f6" strokeWidth="1" />
            <text x="450" y="95" textAnchor="middle" fill="#1e40af" fontSize="12">Data Warehouse</text>

            <rect x="620" y="70" width="180" height="40" rx="5" fill="#dbeafe" stroke="#3b82f6" strokeWidth="1" />
            <text x="710" y="95" textAnchor="middle" fill="#1e40af" fontSize="12">Third-party Data</text>
          </g>

          {/* Metadata & Governance Layer */}
          <g className="metadata-governance">
            <rect x="50" y="160" width="800" height="80" rx="5" fill="#f8fafc" stroke="#94a3b8" strokeWidth="1" />
            <text x="450" y="145" textAnchor="middle" fill="#64748b" fontWeight="bold" fontSize="14">Metadata & Governance</text>

            <rect x="100" y="180" width="220" height="40" rx="5" fill="#e0f2fe" stroke="#0ea5e9" strokeWidth="1" />
            <text x="210" y="205" textAnchor="middle" fill="#0c4a6e" fontSize="12">Metadata Management</text>

            <rect x="380" y="180" width="140" height="40" rx="5" fill="#e0f2fe" stroke="#0ea5e9" strokeWidth="1" />
            <text x="450" y="205" textAnchor="middle" fill="#0c4a6e" fontSize="12">Data Catalog</text>

            <rect x="580" y="180" width="220" height="40" rx="5" fill="#e0f2fe" stroke="#0ea5e9" strokeWidth="1" />
            <text x="690" y="205" textAnchor="middle" fill="#0c4a6e" fontSize="12">Data Governance</text>
          </g>

          {/* Contract Creation Layer */}
          <g className="contract-creation">
            <rect x="100" y="270" width="700" height="100" rx="5" fill="#f8fafc" stroke="#94a3b8" strokeWidth="1" />
            <text x="450" y="255" textAnchor="middle" fill="#64748b" fontWeight="bold" fontSize="14">
              Contract Creation
            </text>

            <rect
              x="150" y="290" width="250" height="60" rx="5"
          ...
          {/* Data Quality & Security Layer */}
          <g className="quality-security">
            <rect x="50" y="400" width="800" height="80" rx="5" fill="#f8fafc" stroke="#94a3b8" strokeWidth="1" />
            <text x="450" y="385" textAnchor="middle" fill="#64748b" fontWeight="bold" fontSize="14">
              Quality & Security
            </text>

            <rect x="100" y="420" width="300" height="40" rx="5" fill="#d1fae5" stroke="#10b981" strokeWidth="1" />
            <text x="250" y="445" textAnchor="middle" fill="#065f46" fontSize="12">
              Data Quality & Validation
            </text>

            <rect x="500" y="420" width="300" height="40" rx="5" fill="#d1fae5" stroke="#10b981" strokeWidth="1" />
          ...
          {/* … your <line> and <path> elements here … */}

        </svg>
      </div>

      {/* Legend, now safely below the diagram */}
      ...
      <div className="mt-6 flex items-start p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        ...
        <div className="text-sm text-yellow-700">
          ...
          <p>
            ...
            structures directly. This dual approach ensures both technical users and business
            users can create data contracts according to their preferences.
          </p>
        </div>
      </div>
    </div>
